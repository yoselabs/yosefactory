"""Fake adapter implementations for v2 protocol tests.
...
The old fakes in tests/fakes.py remain for backward compatibility with
existing tests. New tests should use this module.
"""
...
class FakeGitAdapter:
    ...
    Unlike the old FakeGitAdapter in fakes.py, setup_branch receives the
    full branch name from the engine (no generation) and records it as-is.
    """
